...
- **[24-04-2026] - v1.7.6:** Mejora de UX en Checkout: Implementación de LoadingOverlay premium y soft navigation (`useRouter`) para eliminar parpadeos durante el procesamiento de pagos.
